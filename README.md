...
### 2026-03-15 수정내역
[지난 수정내역](#2025-10-23-중요-수정내역)에서 언급했던 DeepL 웹사이트의 URL 파라미터 문제가 어찌된 일인지 해결이 되었다.  
이에 다시 이전과 같이 그대로 PopClip 클릭만으로 번역된 DeepL 웹 화면을 볼 수 있다.  
(이전 버전과 같이 붙여넣기를 할 필요가 없음!)  
